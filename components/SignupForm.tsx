...
export const SignupForm = () => {
  ...
  const handleResendCode = async () => {
    ...
    try {
      ...
      const errorMessage = "Could not resend the code. Please try again.";
  ...
  const handleVerificationSubmit = async (
    ...
    try {
      ...
      toast("An error occurred during verification. Please try again");
    } finally {
      setIsSubmitting(false);
    }
  };
          ...
          <CardContent className="p-4">
            <form onSubmit={handleVerificationSubmit} className="grid gap-4">
              ...
              <div className="text-sm text-center">
                {!resendTimer ? (
                  <>
                    <span>Didn&apost receive a code?</span>
                    <Button
                      type="button"
